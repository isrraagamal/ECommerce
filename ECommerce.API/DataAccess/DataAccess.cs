    ...
    public class DataAccess : IDataAccess
    {
        ...
        public int InsertOrder(Order order)
        {
            ...
            using (SqlConnection connection = new(dbconnection))
            {
                ...
                string query = "INSERT INTO Orders (UserId, CartId, PaymentId, CreatedAt, Status) values (@uid, @cid, @pid, @cat, 'pending');";
            ...
            using (SqlConnection connection = new SqlConnection(dbconnection))
            {
                ...
                if (reader.Read())
                {
                    payment = new Payment
                    {
                        ...
                        {
                            // Populate PaymentMethod properties if needed
                        },
                        User = new User
                        {
                            // Populate User properties if needed
                        },
